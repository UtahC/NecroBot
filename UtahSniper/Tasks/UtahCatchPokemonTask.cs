...
{
    public static class UtahCatchPokemonTask
    {
        public static int AmountOfBerries;
        private static Random Random => new Random((int)DateTime.Now.Ticks);

        public static async Task<SnipeEnum> Execute(ISession session, CancellationToken cancellationToken, dynamic encounter, MapPokemon pokemon,
            FortData currentFortData = null, ulong encounterId = 0)
        {
            ...
            if (pokeball == ItemId.ItemUnknown) return SnipeEnum.PokemonCatchError;
            ...
            do
            {
                ...
                if (pokeball == ItemId.ItemUnknown)
                {
                    ...
                    return SnipeEnum.PokemonCatchError;
                }
